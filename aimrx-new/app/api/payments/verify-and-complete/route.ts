      ...
      try {
        ...
        await fetch(`${siteUrl}/api/payments/send-confirmation-email`, {
          ...
          body: JSON.stringify({
            ...
            medicationCostCents: transaction.medication_cost_cents,
            shippingFeeCents: transaction.shipping_fee_cents,
            consultationFeeCents: transaction.consultation_fee_cents,
