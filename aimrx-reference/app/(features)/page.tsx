...
export default function Home() {
  ...
  // Delegates (provider assistants) have their own portal at /delegate
  useEffect(() => {
  ...
  // Show admin dashboard for admins (covers admin, super_admin, pharmacy_admin variants)
  if (
    userRole === "admin" ||
  ...
  // Delegates: render nothing while the effect above redirects to /delegate
  if (userRole === "delegate") {
    return null;
  }
