          ...
          <div className="bg-white rounded-[4px] shadow-sm border border-gray-200 p-8">
            ...
            <div className="space-y-6 text-gray-700" style={{ fontFamily: 'Inter, sans-serif' }}>
              ...
              <section>
                ...
                <p>
                  If you have questions about this consent or our telemedicine services, please contact us at (769) 304-1830 or visit us at 106 E 6th St, Suite 900, Austin, TX 78701.
                </p>
              </section>
            </div>
          </div>
