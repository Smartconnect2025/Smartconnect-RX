...
export async function POST(request: Request) {
  ...
  try {
    ...
    const { name, slug, logo_url, primary_color, tagline, address, npi, dea_number, ncpdp_number, phone, contact_email, notification_emails, system_type, api_url, api_key, store_id, location_id } = body;
