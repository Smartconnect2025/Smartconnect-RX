...
export async function PUT(
  ...
  try {
    ...
    // Update pharmacy basic info. NOTE: shipping_fee_cents is intentionally
    // NOT updatable through this profile endpoint — it has its own dedicated
    // endpoint at /api/admin/pharmacies/[id]/shipping-fee to keep saves
    // isolated and prevent any chance of accidentally clobbering pricing.
