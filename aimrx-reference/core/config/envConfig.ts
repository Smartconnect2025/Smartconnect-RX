...
export const envConfig = {
  ...
  NEXT_PUBLIC_SUPPORT_EMAIL:
    process.env.NEXT_PUBLIC_SUPPORT_EMAIL ?? "support@aimrx.com",
  ...
  SENDGRID_FROM_NAME: process.env.SENDGRID_FROM_NAME ?? "AIM RX Portal",
  ...
  AUTHNET_PUBLIC_KEY: process.env.AUTHNET_PUBLIC_KEY ?? "",
