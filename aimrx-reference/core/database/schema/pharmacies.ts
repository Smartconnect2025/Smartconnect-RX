...
export const pharmacies = pgTable(
  "pharmacies",
  {
    ...
    notification_emails: text("notification_emails"),
    // Per-pharmacy shipping fee in cents. Admin-controlled. Providers cannot
    // change this. Default $25.
    shipping_fee_cents: integer("shipping_fee_cents").notNull().default(2500),
