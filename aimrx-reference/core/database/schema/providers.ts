...
export const providers = pgTable(
  "providers",
  {
    ...
    prefix: text("prefix").notNull().default("Dr."), // Display title before name (e.g. "Dr.", "NP", "PA")
    ...
    default_shipping_fee: integer("default_shipping_fee").default(25), // Default shipping fee for prescriptions
    ...
    pay_on_terms: boolean("pay_on_terms").notNull().default(false), // Bypass payment - auto-mark orders as paid and submit to pharmacy
